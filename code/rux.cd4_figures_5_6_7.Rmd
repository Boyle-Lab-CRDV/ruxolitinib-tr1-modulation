...
group_medians <- table_data_donor %>%
  group_by(timepoint, cluster, group) %>%
  summarise(median_percent = median(percent_total), .groups = "drop")

#plot primary first
table_data_donor_primary <- table_data_donor %>%
  filter(timepoint %in% c("I", "T", "T+3", "T+7", "T+20"))

group_means_primary <- group_medians %>%
  filter(timepoint %in% c("I", "T", "T+3", "T+7", "T+20"))
...
p_combined <- ggplot() +
  ...
  geom_line(
    ...
    aes(x = timepoint, y = median_percent, color = group, group = interaction(cluster, group)),
    size = 1.5,
    linetype = "solid"
  ) +
...
tr1.t7$significant <- with(tr1.t7, ifelse(p_val < 0.01, "Significant", "Not Significant"))

# Volcano plot
sig_genes <- tr1.t7[tr1.t7$p_val < 0.01 & abs(tr1.t7$logFC) > 1, ] # genes to label

#colour up and down regulated
tr1.t7$direction <- with(tr1.t7, ifelse(p_val < 0.01 & logFC > 0, "RUX",
                                        ifelse(p_val < 0.01 & logFC < 0, "Placebo", "NS")))
...
p <- ggplot(tr1.t7, aes(x = logFC, y = -log10(p_val))) +
  ...
  geom_hline(yintercept = -log10(0.01), linetype = "dashed", color = "#736d6d") +
...
#rT3
# Add a column for significance labeling
tr1.rt3$significant <- with(tr1.rt3, ifelse(p_val < 0.01, "Significant", "Not Significant"))

# Volcano plot
sig_genes <- tr1.rt3[tr1.rt3$p_val < 0.01 & abs(tr1.rt3$logFC) >1, ] # genes to label

#colour up and down regulated
tr1.rt3$direction <- with(tr1.rt3, ifelse(p_val < 0.01 & logFC > 0, "RUX",
                                        ifelse(p_val < 0.01 & logFC < 0, "Placebo", "NS")))
...
#T7
# Add a column for significance labeling
tfh.t7$significant <- with(tfh.t7, ifelse(p_val < 0.01, "Significant", "Not Significant"))

# Volcano plot
sig_genes <- tfh.t7[tfh.t7$p_val < 0.01 & abs(tfh.t7$logFC) > 1, ] # genes to label

#colour up and down regulated
tfh.t7$direction <- with(tfh.t7, ifelse(p_val < 0.01 & logFC > 0, "RUX",
                                        ifelse(p_val < 0.01 & logFC < 0, "Placebo", "NS")))
...
# rT3
# Add a column for significance labeling
tfh.rt3$significant <- with(tfh.rt3, ifelse(p_val < 0.01, "Significant", "Not Significant"))

# Volcano plot
sig_genes <- tfh.rt3[tfh.rt3$p_val < 0.01 & abs(tfh.rt3$logFC) > 1, ] # genes to label

#colour up and down regulated
tfh.rt3$direction <- with(tfh.rt3, ifelse(p_val < 0.01 & logFC > 0, "RUX",
                                        ifelse(p_val < 0.01 & logFC < 0, "Placebo", "NS")))
...
#T7
# Add a column for significance labeling
th1.t7$significant <- with(th1.t7, ifelse(p_val < 0.01, "Significant", "Not Significant"))

# Volcano plot
sig_genes <- th1.t7[th1.t7$p_val < 0.01 & abs(th1.t7$logFC) > 1, ] # genes to label

#colour up and down regulated
th1.t7$direction <- with(th1.t7, ifelse(p_val < 0.01 & logFC > 0, "RUX",
                                        ifelse(p_val < 0.01 & logFC < 0, "Placebo", "NS")))
...
#rT3
# Add a column for significance labeling
th1.rt3$significant <- with(th1.rt3, ifelse(p_val < 0.01, "Significant", "Not Significant"))

# Volcano plot
sig_genes <- th1.rt3[th1.rt3$p_val < 0.01 & abs(th1.rt3$logFC) >1, ] # genes to label

#colour up and down regulated
th1.rt3$direction <- with(th1.rt3, ifelse(p_val < 0.01 & logFC > 0, "RUX",
                                        ifelse(p_val < 0.01 & logFC < 0, "Placebo", "NS")))
